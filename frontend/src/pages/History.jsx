...
export default function History() {
  ...
  // newest first (just in case backend doesn't sort)
  ...
  async function loadEntryDetail(dateStr) {
    // Optional: fetch full entry by date for accurate note/prompt fields
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-600">
              Review your past mood check-ins.
            </p>
          </div>
            ...
            <div className="bg-white border rounded-xl overflow-hidden">
              ...
              {sortedEntries.length === 0 ? (
                ...
                <ul className="divide-y">
                  {sortedEntries.map((e) => {
                    const dateStr = e.entry_date || e.date; // backend likely uses entry_date
                    ...
                    return (
                      <li key={dateStr || `${moodVal}-${Math.random()}`}>
                        <button
                          type="button"
                          onClick={() => {
